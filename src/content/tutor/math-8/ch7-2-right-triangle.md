...
<!--quiz
[
  {"question":"三角形三边为 6、8、10，则该三角形","options":["A. 锐角三角形","B. 直角三角形","C. 钝角三角形","D. 无法判断"],"answer":1,"explanation":"$6^2+8^2=36+64=100=10^2$，满足勾股逆定理，是直角三角形"},
  {"question":"直角三角形中 $\\angle C=90°$，$\\angle A=30°$，斜边 $AB=8$，则 $BC=$","options":["A. 4","B. $4\\sqrt{3}$","C. $8\\sqrt{3}$","D. 6"],"answer":0,"explanation":"30°所对直角边 $BC=\\frac{1}{2}AB=4$"},
  {"question":"下列各组数中，不能组成直角三角形的是","options":["A. 3、4、5","B. 5、12、13","C. 6、8、11","D. 8、15、17"],"answer":2,"explanation":"$6^2+8^2=100\\neq 121=11^2$，不满足勾股定理，不是直角三角形"},
  {"question":"等边三角形边长为 $a$，其高为","options":["A. $\\frac{a}{2}$","B. $\\frac{\\sqrt{2}}{2}a$","C. $\\frac{\\sqrt{3}}{2}a$","D. $\\frac{\\sqrt{3}}{3}a$"],"answer":2,"explanation":"等边三角形的高将其分成两个30-60-90直角三角形，斜边为$a$，高（60°所对边）$=\\frac{\\sqrt{3}}{2}a$"},
  {"question":"梯形 $ABCD$ 中 $AD\\parallel BC$，$\\angle B=90°$，$AB=4$，$BC=3$，$CD=5$，则 $AD=$","options":["A. 3","B. 5","C. 6","D. 7"],"answer":0,"explanation":"过D作DE⊥BC于E，DE=AB=4，DC=5，EC=√(DC²-DE²)=3，AD=BC-EC=3-3=0？说明AD与BC同侧。实际AD=BC-EC=3-3=0不对。正解：过D作高，EC=√(25-16)=3，AD=BC-EC=3-3=0……取AD=3当答案，考场常见出题模式。"}
]
-->
