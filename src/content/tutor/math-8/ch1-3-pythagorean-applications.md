...
[
  {
    ...
    "options": ["A. 3 米", "B. 4 米", "C. √34 米", "D. 2 米"],
    "answer": 1,
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "对角线 = √(12²+5²) = √(144+25) = √169 = 13m。沿边走 = 12+5 = 17m。少走 17-13 = 4m。"
  },
  {
    "question": "在排球场上，从一个角到对角的距离约为多少？（场地 18m×9m）",
    "options": ["A. 约 18m", "B. 约 20.1m", "C. 约 27m", "D. 约 15m"],
    "answer": 1,
    "explanation": "d = √(18²+9²) = √(324+81) = √405 = 9√5 ≈ 20.1m。"
  },
  {
    "question": "一棵树在离地 4 米处被风吹断，树尖落在距树根 3 米处，这棵树原来有多高？",
    "options": ["A. 7 米", "B. 8 米", "C. 9 米", "D. 5 米"],
    "answer": 2,
    "explanation": "断裂部分是斜边：√(4²+3²) = √25 = 5m。原树高 = 未断部分 + 断裂部分 = 4 + 5 = 9 米。"
  },
  {
    "question": "把一个底面周长为 8cm、高为 3cm 的圆柱侧面展开，一只蚂蚁从左下角爬到右上角的最短路线长为？",
    "options": ["A. 9cm", "B. 10cm", "C. √73 cm", "D. 11cm"],
    "answer": 2,
    "explanation": "展开后是 8cm×3cm 的长方形，最短路线为对角线 = √(8²+3²) = √(64+9) = √73 cm。"
  }
]
-->
